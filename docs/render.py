...
for (t, *_), lines in zip(A, panes):
    ...
    for ln in lines: body.append('<text x="30" y="%d" xml:space="preserve">%s</text>' % (y + 6, tspans(ln))); y += lh
    y += 22
...
for who, msg, col in judge:
    body.append('<text x="30" y="%d" xml:space="preserve"><tspan fill="#5a5d66">%-14s</tspan><tspan fill="%s">%s</tspan></text>' % (y, who, col, html.escape(msg))); y += lh
...
<text x="30" y="29" xml:space="preserve">%s<animate attributeName="opacity" values="1;1;0;0;1" keyTimes="0;0.45;0.5;0.95;1" dur="6s" repeatCount="indefinite"/></text>
<text x="30" y="29" xml:space="preserve" opacity="0">%s<animate attributeName="opacity" values="0;0;1;1;0" keyTimes="0;0.45;0.5;0.95;1" dur="6s" repeatCount="indefinite"/></text>
<text x="30" y="49" xml:space="preserve">%s</text></svg>''' % (W, W, font, FS, W - 32, before, promo, tspans(panes[2][1])))
